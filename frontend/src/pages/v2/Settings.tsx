...
const LABELS: Record<string, string> = {
  ...
  codex_summary_model: "Codex 文字模型",
  codex_reasoning_effort: "Codex 思考强度",
  codex_image_model: "生图执行模型",
  ...
  ai_base_url: "DeepSeek Base URL",
  ai_api_key: "DeepSeek API Key",
  ai_model: "DeepSeek 模型 ID",
  ...
  ai_request_concurrency: "DeepSeek 请求并发数",
...
const SETTING_GROUPS = [
  ...
  },
  {
    id: "model",
    title: "模型与 Prompt",
    description: "各群可分别选择聊天分析与海报文案模型。备用 Provider 设为 none 时不自动切换；Codex 思考强度同时用于文字和生图执行。",
    icon: PlugsConnected,
    keys: ["summary_provider_primary", "summary_provider_fallback", "codex_summary_model", "codex_reasoning_effort", "codex_image_model", "codex_summary_timeout_seconds", "codex_summary_max_retries", "ai_base_url", "ai_model", "ai_api_key", "ai_timeout_seconds", "ai_max_retries", "max_context_chars"],
  },
  {
    id: "advanced",
    title: "高级并发设置",
    description: "控制群任务、微信取数、Codex 文字处理和 DeepSeek 请求的并发上限。",
    icon: GearSix,
